...
export default function Cart() {
  ...
  return (
    <div className="flex justify-center">
      <div
        className="w-8/10 border-2 flex items-center flex-col gap-4  "
        style={{ padding: "4px" }}
      >
        {cartitem.map((data, index) => {
          return (
            <div className="w-9/10  border-1 flex ">
              ...
              <div className="w-8/10 bg-red-300 box-border " style={{padding:"4px"}}>
                ...
                <button className="border-2 box-border rounded-2xl bg-red-600 text-white font-bold cursor-pointer hover:bg-blue-500 " style={{padding:"4px"}} onClick={()=>{
                  dispatch({
                    type:"delete",
                    payload:data
                  })
